...
<div class="container">
    ...
    <h2 class="text-center text-uppercase"> RECEIPT
    </h2>
    <div class="row">
        <div class="col-md-6"></div>
        <div class="col-md-6" style="background: black">
            <form action="new-receipt.php" method="post">

                <label for=""  style="color: hotpink"><b>date</b></label>
                <input type="date" name="receipt_date" placeholder="*date" required class="form-control">
                ...
                <input type="text" name="tution_fees" placeholder="*enter registration " required class="form-control" >
                ...
                <label for=""  style="color: hotpink">amount paid</label>
                <input type="number" name="amount_paid" placeholder="*your fees" class="form-control" required>
